 ...
 */
export const getGetAvailableTimesUrl = (params: GetAvailableTimesParams) => {
  ...
  return stringifiedParams.length > 0
    ? `/api/appointments/available-times?${stringifiedParams}`
...
export const getAvailableTimes = async (
  ...
  return customFetch<AvailableTimes>(getGetAvailableTimesUrl(params), {
    ...options,
    method: "GET",
  });
};

export const getGetAvailableTimesQueryKey = (
  params?: GetAvailableTimesParams,
) => {
  return [
    `/api/appointments/available-times`,
...
export const getGetAvailableTimesQueryOptions = <
  TData = Awaited<ReturnType<typeof getAvailableTimes>>,
  TError = ErrorType<unknown>,
>(
  params: GetAvailableTimesParams,
  options?: {
    query?: UseQueryOptions<
      Awaited<ReturnType<typeof getAvailableTimes>>,
      TError,
      TData
    >;
    request?: SecondParameter<typeof customFetch>;
  ...
  const queryKey =
    queryOptions?.queryKey ?? getGetAvailableTimesQueryKey(params);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getAvailableTimes>>
  > = ({ signal }) => getAvailableTimes(params, { signal, ...requestOptions });
...
export type GetAvailableTimesQueryResult = NonNullable<
  Awaited<ReturnType<typeof getAvailableTimes>>
>;
...
>(
  ...
  const queryOptions = getGetAvailableTimesQueryOptions(params, options);
